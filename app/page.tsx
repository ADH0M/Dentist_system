          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-xl bg-card border border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                At Dr Taha Dental Clinic, we combine advanced dental technology
                with refined clinical expertise to deliver precision-driven
                treatments and exceptional, long-lasting results.
              </p>
            </div>
            <div className="p-6 rounded-xl bg-card border border-border shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-6 rounded-xl bg-card border border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                Every smile is unique. We provide tailored treatment plans in a
                sophisticated, comfortable environment designed to ensure
                confidence, comfort, and complete patient satisfaction.
              </p>
            </div>
          </div>
        </div>
